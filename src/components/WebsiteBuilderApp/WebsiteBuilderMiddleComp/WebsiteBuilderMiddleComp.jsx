...
import "./WebsiteBuilderMiddleComp.css";
...
export const WebsiteBuiulderMiddleComp = () => {
  ...
  return (
    <div className='middleCompParentDiv'>
      <div className='middleCompHeadingOuterDiv'>
        ...
        <button className='middleCompHeadingButton'> Get started </button>
      </div>

      <div className='middleCompImageSliderOuterDiv'>
        <Slider {...settings}>
          {homeService.map((item, i) => (
            <div key={i} className="middleCompWebsiteImageSlider">
              <div>
