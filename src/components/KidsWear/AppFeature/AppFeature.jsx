...
export const AppFeature = () => {
  return (
    <div>
<div className='AppFeature-maindiv'>
    <div className='AppFeature-innermaindiv1'>
        <h1>Customer </h1>
        <h1><span style={{color: "orangered"}}>App</span> Features</h1>
        <div className='AppFeature-innermaindivbox'>
            <div className='AppFeature-innermaindivboxcontain1' >
              <div>
            ...
            <div className='AppFeature-innermaindivboxcontain' >
              <div>
    ...
    <div className='AppFeature-innermaindiv21'>
...
<div className='AppFeature-maindivadmin'>

<div className='AppFeature-innermaindiv2admin'>
    ...
    <div className='AppFeature-innermaindiv1admin'>
        ...
        <div className='AppFeature-innermaindivboxadmin'>
            ...
            <div className='AppFeature-innermaindivboxcontainadmin' >
              <div>
...
<div className='AppFeature-maindiv'>
    ...
    <div className='AppFeature-innermaindiv2'>
