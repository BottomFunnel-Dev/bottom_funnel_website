...
export const BISlider = () => {
  ...
  const NextArrow = ({ onClick }) => {
    return (
      <div
        className="BISlider-slider-arrow BISlider-slider-next"
        onClick={onClick}
      >
        <FaArrowRight />
      </div>
  ...
  const PrevArrow = ({ onClick }) => {
    return (
      <div
        className="BISlider-slider-arrow BISlider-slider-prev"
        onClick={onClick}
      >
        <FaArrowLeft />
      </div>
  ...
  return (
    <div className="BISlider-sliderDiv">
      <h1>
        Our <span>Tech</span> Stack
      </h1>
      <div className="BISlider-hr-line">
        <span></span>
        <div></div>
        <span></span>
      </div>
