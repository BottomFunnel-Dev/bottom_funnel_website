...
export const CustomWebSolutions = () => {
  ...
  return (
    <div className="CustomWebSolutions-Container">
      <div className="CustomWebSolutions-Background-rectangle">
        <img
      ...
      <div className="CustomWebSolutions-main">
        <h1>
          Bottom Funnel Customised <span>Web</span> Solutions
        </h1>
        <div className="CustomWebSolutions-hr-line">
          <span></span>
          <div></div>
          <span></span>
        </div>
        <div className="CustomWebSolutions-Cards-Container">
          {cardsData.map(({ title, image, body }) => {
            return (
              <div key={title} className="CustomWebSolutions-Cards-main">
                <div>
