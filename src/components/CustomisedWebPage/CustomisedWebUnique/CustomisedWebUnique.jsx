...
import "./CustomisedWebUnique.css";

export const CustomisedWebUnique = () => {
  return (
    <div className="CustomisedWebUnique-container">
      <div className="CustomisedWebUnique-content">
        <h1>Customize your website to suit your unique requirements.</h1>
        <div className="CustomisedWebUnique-hr-line">
          <span></span>
          <div></div>
          <span></span>
        </div>
      ...
      <div className="CustomisedWebUnique-image">
