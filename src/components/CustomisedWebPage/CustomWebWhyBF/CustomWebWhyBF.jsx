...
export const CustomWebWhyBF = () => {
  ...
  return (
    <div className="CustomWebWhyBF-main">
      <h1>
      ...
      <div className="CustomWebWhyBF-container">
        <div className="CustomWebWhyBF-content">
        ...
        <div className="CustomWebWhyBF-image">
          <img
