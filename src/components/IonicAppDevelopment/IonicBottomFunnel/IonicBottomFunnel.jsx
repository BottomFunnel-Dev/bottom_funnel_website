...
import "./IonicBottomFunnel.css";

export const IonicBottomFunnel = () => {

    return (
        <>
            <div className="ionicBottomFunnelMainDiv">
                <div className="ionicBottomFunnelHeading">
                    {/* <h3>Trusted</h3> */}
                    <h1>Ionic Mobile App Development Comapany</h1>
                    <p>
                    ...
                    <h1 className="ionicBottomFunnelHeading1">Ionic App Development Services By Bottom Funnel</h1>
                    <p>
