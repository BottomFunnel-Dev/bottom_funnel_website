...
export const IcecreamBanner = () => {
  return (
    <div className='icecreambannermainboxes'>
    <div className='icreambannersometextbox'>
    <h1>Launch an On-Demand</h1>
    <h2><span className='specialcolor'>Ice-cream</span> Delivery App</h2>
    ...
    <button className='icecreambannerbutton'>Get Started</button>
    </div>
