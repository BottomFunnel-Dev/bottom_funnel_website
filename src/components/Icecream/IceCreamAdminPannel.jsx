...
import "./IceCreamAdminPannel.css"
...
export const IceCreamAdminPannel = () => {
  ...
  return (
    <div className='icecreamadminpannelmainboxes'>
    <div className='icecreamadminpannelmainboxsometextupper'>
    <h2>Admin Pannel</h2>
    </div>
    <div className='icecreamadminpannelmainflexboxclass'>
    <div className='icecreamadminpannelleftbox'>{icecreamadmindata.map((e)=>{
        return (
            <div className='icecreamadminpannelmapperboxindivisyal'
            ...
            >
            <div className='icecreamadminpannelmapperboxindivisyalicon'>
            <img src={e.icon} alt="" />
            </div>
    ...
    <div className='icecreamadminpannelrightbox'>
    <div className='icecreamadminpannelrightboxinnerimage'>
