...
export const IceCreamDriverApp = () => {
  ...
  const icreacreamdriverappdata = [
    ...
    return (
      <div className='icecreamdriverappmainboxes'>
     
      <h2>Driver App</h2>
      <div className='icecreamdriverappflexingbox'>
      <div className='icecreamdriverappflexingboxleftbox'>
      <div className='icecreamdeliveryappleftboxinsiderupperimage'>
      <img src={imageChange} alt='' />
      </div>
      </div>
      <div className='icecreamdriverappflexingboxrightbox'>{icreacreamdriverappdata.map((e)=>{
          return (
              <div className='icecreamdriverappindivisualbox'
