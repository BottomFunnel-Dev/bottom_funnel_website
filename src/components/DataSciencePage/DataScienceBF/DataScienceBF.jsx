...
export const DataScienceBF = () => {
  ...
  return (
    <div className="DataScienceBF-Container">
      <div className="DataScienceBF-Background-rectangle">
        <img
      ...
      <div className="DataScienceBF-main">
        <h1>
          <span>Data</span> Science Solutions
        </h1>
        <div className="DataScienceUnique-hr-line">
          <span></span>
          <div></div>
          <span></span>
        </div>
        <div className="DataScienceBF-Cards-Container">
          {cardsData.map(({ title, image, body }) => {
            return (
              <div key={title} className="DataScienceBF-Cards-main">
                <div>
