...
import "./DataScienceServices.css";
...
export const DataScienceServices = () => {
  ...
  return (
    <div className="DataScienceServices-container">
      <div className="DataScienceServices-heading">
      ...
      <div className="DataScienceServices-main">
