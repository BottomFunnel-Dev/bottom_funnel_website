...
export const FintechWhyChooseUs = () => {
  ...
  return (
    <div className='fintechwhychooseus'>  
    
    
    <div className='fintechwhychooseusmainboxes'>
    <div className='fintechwhychoosetextboxleft'>
    <h1>Why Choose <span className='specialtxt'>Us</span></h1>
    </div>
    <div className='fintechwhychoosetextboxright'>
    <p>There are a lot of online marketing companies out there, and it can be difficult to determine which one is right for your business. That's why we recommend choosing Bottom Funnel - our team has years of experience in the industry, and we know how to help you reach your goals.</p>
    </div>
</div>



    <div className='fintechsolutionwhychooseusflexingbox'>{whychooseusfintechsolutiondata.map((e)=>{
        return (
        <div className='whychooseusaftermappingdatabox'>
        <div className='whychooseusfintechlogobox'><img src={e.img} alt="logo" /></div>
        <div className='whychooseustxtbox'><h4>{e.htxt}</h4>
        <p>{e.stxt}</p>
        </div>
