...
const fintechexclusivedata = [
  ...
  return (
    <div className='fintechsolutionexclusivemainboxes'>
    <div className='fintechsolutionexclusivetextboxheader'>
    <div className='fintechexclusiveleftboxfortext'><h1><span className='specialtextcolored'>Exclusive</span> Features</h1></div>
    <div className='fintechexclusiverightboxfortext'><p>We are Fintech App Solution and we offer you exclusive features. Here, you can get the best of banking services in a hassle-free manner that is quick, convenient and secure. </p></div>
    </div>
    <div className='flexingboxoffintechexclusive'>{fintechexclusivedata.map((e)=>{
      return (
        <div className='fintechsolutionsflexingboxaftermapping'><h3>{e.htxt}</h3>
        <p>{e.stxt}</p>
        </div>
      )
    })}</div>
