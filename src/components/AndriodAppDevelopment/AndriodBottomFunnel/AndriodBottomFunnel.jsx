...
import "./AndriodBottomFunnel.css";

export const AndriodBottomFunnel = () => {

    return (
        <>
            <div className="andriodBottomFunnelMainDiv">
                <div className="andriodBottomFunnelheading">
                    <h1> Why Choose Bottom Funnel For Mobile App Development </h1>
                </div>

                <div className="andriodBottomFunnelContainerDiv">
                    <div className="andriodBottomFunnelServiceBox">
                        <div className="andriodBottomFunnelContainerBoxes">
                            <div className="andriodBottomFunnelBoxIcon">
                                <img className="andriodBottomFunnelImage" src="Images/AndriodDevImages/icons/1lightbulb.png" />
                            </div>
                        ...
                        <div className="andriodBottomFunnelContainerBoxes">
                            <div className="andriodBottomFunnelBoxIcon">
                                <img className="andriodBottomFunnelImage" src="Images/AndriodDevImages/icons/1security.png" />
                            </div>
                            <div className="andriodBottomFunnelBoxHeading">
