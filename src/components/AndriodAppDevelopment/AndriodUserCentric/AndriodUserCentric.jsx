...
import "./AndriodUserCentric.css";

export const AndriodUserCentric = () => {
  return (
    <>
      <div className="andriodUserCentricMainDiv">
        <div className="andriodUserCentricIconContainer">
          <div className="andriodUserCentricIconOuterBox">
            <div className="andriodUserCentricContainerDiv">
              <div className="andriodUserCentricIcon">
                <img src="Images/AndriodDevImages/icons/analyse 1.png" />
              </div>
              <div className="andriodUserCentricIconHeading">
            ...
            <div className="andriodUserCentricContainerDiv">
              <div className="andriodUserCentricIcon">
                <img src="Images/AndriodDevImages/icons/interest-rate 1.png" />
              </div>
              <div className="andriodUserCentricIconHeading">
          ...
          <div className="andriodUserCentricIconOuterBox">
            <div className="andriodUserCentricContainerDiv">
              <div className="andriodUserCentricIcon">
                <img src="Images/AndriodDevImages/icons/app-development (2) 1.png" />
              </div>
              <div className="andriodUserCentricIconHeading">
            ...
            <div className="andriodUserCentricContainerDiv">
              <div className="andriodUserCentricIcon">
                <img src="Images/AndriodDevImages/icons/agile (2) 1.png" />
              </div>
              <div className="andriodUserCentricIconHeading">
        ...
        <div className="andriodUserCentricContent">
          <h1 className="andriodUserCentricContentHeading">
            User-Centric Mobile App Development Solutions
          </h1>
          <p className="andriodUserCentricContentText">
