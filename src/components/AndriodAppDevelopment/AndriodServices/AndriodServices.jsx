  ...
  return (
      <>
        <div className="andriodServicesMainDiv">
            ...
            <div className="andriodServicesDescription">
                ...
                <div className="andriodServiceBox">
                    <div className="andriodServicesContainerBoxes">
                        <div className="andriodServiceBoxIcon">
                            <img className="andriodServiceImage" src="Images/AndriodDevImages/Icons/Rectangle 4478.png"/>
                        </div>
