...
import "./EyeWearDevelopmentSolution.css";
...
export const EyeWearDevelopmentSolution = () => {
    const EyeWeardeliverydata = [
        ...
        
        {
          ...
          return (
            <div className='Eyeweardevelopmentmainbox'>
            <div className='eyeweardeliveryservicetextbox'>
            <h1>Rideshare & Carpooling App Development Solutions We Provide</h1>
            <p>Looking for a cutting-edge rideshare or carpooling app development solution? Look no further than Bottom Funnel. We are a leading provider of innovative rideshare and carpooling app development solutions, and we are committed to helping our clients succeed.</p>
            </div>
           <div className='eyeweardeliveryservicebackgroundimagebox'>{EyeWeardeliverydata.map((el)=>{
            
            return (
            <div className='eyeweardeliveryserviceboxesmap'>
           <div className='eyedeliveryserviceinnerboximagebox'><img src={el.icon} alt="icon image" /></div>
          <div><h5>{el.htxt}</h5>
          <p>{el.stxt}</p>
      ...
      <button className='Eyeweardevelopmentsolutionbutton'>Get Started</button>
