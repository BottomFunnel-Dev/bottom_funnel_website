...
export const AppBuilderCreate = () => {
  ...
  return (
    <div className='appbuildercreatemainboxes'>
    <div className='appbuildercreateleftbox'>
    <h1>Create Your Mobile App in 4 Steps</h1>
    <p>Our online app builder allows your to build mobile apps without coding ! follow these steps to make native mobile apps. </p>
   <div className='appbuildercreatedatamapper'>{cppbuildercreatedata.map((e)=>{
    return (
        <div className='appbuildercreatedatawiseinduvisully'><h4>{e.htxt}</h4>
    ...
    <div className='appbuildercreaterightbox'>
