...
export const AviationAirlines = () => {
  ...
  return (
    <div className='aviationairlinesmainboxes'>
    <div className='aviationairlinesupperboxamazing'>
    <div className='aviationupperbox1'>
    <h1>7+</h1>
    ...
    <div className='aviationupperbox2'>
    <h1>99 %</h1>
...
<div className='avitaionairlinesagaintextonlytext'>
<h1><span className='coloredspecial'>Airline Software</span> Development Service We Offer</h1>
...
<div className='datamappingindivisalboxairlineaviation'>{aviationairlinesdata.map((e)=>{
    return(
        <div className='aviationairlinesdatamappingboxes'>
        <div className='logoboxairlinesaviations'>
        <img src={e.logo} alt="logo" />
        </div>
        <div className='aviationairlinesmappertextboxes'><h4>{e.htxt}</h4>
        <p>{e.stxt}</p>
