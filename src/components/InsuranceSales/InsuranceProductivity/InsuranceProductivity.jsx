...
import './InsuranceProductivity.css'

export const InsuranceProductivity = () => {
  return (
    <div>
     <div className='InsuranceProductivity-maindiv'>
        <div className='InsuranceProductivity-maindiv1'>
            <div  className='InsuranceProductivity-maindiv1image'>
                <img src="Images/InsuranceSalesphotos/Thinkingface-cuate.png" alt="" />
            </div>
            <div className='InsuranceProductivity-maindiv1contain'>
                <h1>But, is there room for productivity in an insurance </h1>
            <h1> sales agent’s day?</h1>
            </div>

        </div>
        <div className='InsuranceProductivity-innermaindiv2'>
         <div className='InsuranceProductivity-innermaindiv2contain'>
         ...
         <div className='InsuranceProductivity-innermaindiv2image'>
