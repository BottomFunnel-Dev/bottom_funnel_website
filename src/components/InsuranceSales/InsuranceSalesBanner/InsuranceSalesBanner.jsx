...
export const InsuranceSalesBanner = () => {
  return (
    <div>
          <div className='InsuranceSalesbannermainbox'>
    <div className='InsuranceSalesbannermainboxinnertextdiv'>
    <h1>CRM for Insurance</h1>
    <p>Save time, build loyal customers, and stand out in your business with an insurance CRM software. </p>
    <button className='InsuranceSalesbannerbutton'>TRY FOR FREE</button>
    </div>
  </div>
    </div>
  )
