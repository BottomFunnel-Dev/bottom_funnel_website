...
export const SportsBanner = () => {
  return (
    <div className="sportsbanner">
      <div className="bettingSectionleft">
      ...
      <div className="bettingSectionright">
        <div className="bettingImage">
          <img src="Images/sportsbettingpage/banners/bannerimg.png" alt="" />
        </div>
      </div>
    </div>
  );
