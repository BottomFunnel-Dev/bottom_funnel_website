...
import "./KotlinCards.css";

export const KotlinCards = () => {
  return (
    <>
      <div className="kotlinCardsMainDiv">
        <div className="kotlinCardsContainer">
          <div className="kotlinCardsBox">
            <div className="kotlinCardSaving">
              <img
                className="kotlinCardSavingImage"
