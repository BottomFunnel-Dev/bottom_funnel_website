...
import './TailorBusiness.css'


export const TailorBusiness = () => {
  return (
    <div>
      <div className='TailorBusiness-maindiv'>
        
        <div className='TailorBusiness-innerdiv'>
       ...
       <p>As your company grows with the ever-expanding list of properties, you need a real estate CRM that grows with you. Bottom Funnel Sales allows you to truly make it your own by creating custom modules—a dedicated space to capture and track information about your business solutions.</p>
            ...
            <p className='TailorBusiness-more'>Learn More</p>
            <div className='TailorBusiness-imagediv'>
        ...
        <div className='TailorBusiness-innerdiv'>
         ...
         <p>Manage prospects from different sources on a real estate CRM software, like Freshsales, that automatically captures the clients’ information. Once the leads are captured, their social and public information are auto-enriched. Now your agents can directly jump into action, armed with the primary information they need.</p>
          <p>Freshsales  real estate CRM can also auto-assign your prospects to the right agent based on the geography, lead source, etc., in a fair and round-robin fashion. Now, you do not only get rid of manually assigning leads, but you can also boost your lead response time.</p>
          <p className='TailorBusiness-more'>Learn More</p>
            <div className='TailorBusiness-imagediv'>
