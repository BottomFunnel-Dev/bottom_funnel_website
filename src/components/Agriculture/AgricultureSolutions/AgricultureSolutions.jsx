...
import "./AgricultureSolutions.css";
...
export const AgricultureSolutions = () => {
    ...
    return (
        <div className='agricultureSolutionsParentDiv'>
            <div className='agricultureSolutionsHeadingDiv'>
                <h1>
            ...
            <div className="agricultureSolutionsMainDataCards">
