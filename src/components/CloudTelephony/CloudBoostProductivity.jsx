...
import "./CloudBoostProductivity.css"
...
const cloudboostproddata=[
  ...
  return (
    <div className='cloudboostproductivitymainboxes'>
    <div className='cloudboostproductuppertext'>
    ...
    <div className='cloudboostproductmapperbox'>{cloudboostproddata.map((e)=>{
        return (
            <div className='cloudboostproductivityindiboxmapper'>
            <div className='cloudboostprodicon'>
            <img src={e.icon} alt='images' />
            </div>
            <div className='cloudboostprotxt'>
            <h4>{e.htxt}</h4>
            <p>{e.txt}</p>
            </div>
