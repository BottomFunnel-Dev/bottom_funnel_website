...
import "./CloudIncrease.css"


export const CloudIncrease = () => {
  return (
    <div className='cloudincreasesalesmainboxes'>
    <div className='cloudincreasesalestextboxupper'>
    <h1>Increase sales efficiency with built-in <span className='cloudcolored'>cloud telephony</span></h1>
    ...
    <div className='cloudincreasesalesboxflexingdiv'>
    <div className='cloudincreasesalesboxflexingdivleft'>
    ...
    <div className='cloudincreasesalesboxflexingdivright'>
