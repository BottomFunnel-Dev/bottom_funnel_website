...
import "./AcoholAdminpanel.css";

export const AcoholAdminpanel = () => {
  let adminpanelData = [
    {
  ...
  return (
    <div className="alcohol-admin-panel-main">
      <div className="alcohol-admin-panel-div-main">
        <div className="alcohol-admin-panel-div-content">
          <h2>Admin Panel</h2>
          <div>
        ...
        <div className="alcohol-admin-panel-div-images">
          <img
            src="Images/alcoholPhotos/admin-panel-image.png"
            alt="Admin panel "
          />
        </div>
      </div>
