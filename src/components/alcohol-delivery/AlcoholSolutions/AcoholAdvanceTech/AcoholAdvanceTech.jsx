...
import "./AcoholAdvanceTech.css";

export const AcoholAdvanceTech = () => {
  let customerAppData = [
    {
  ...
  return (
    <div className="alcohol-advance-tech-main">
      <h1>
        SOLUTIONS FOR YOUR <span> FOOD DELIVERY APP </span>
      </h1>
      <div className="alcohol-customer-app-main">
        <div className="alcohol-customer-app-images">
          <div>
            <img
          ...
          <div>
            <img
              src="Images/alcoholPhotos/mobile-screen-1.png"
              alt="customer app iphone image"
            />
          </div>
        </div>
        <div className="alcohol-customer-app-content">
          <h2>Customer app</h2>
          <div>
