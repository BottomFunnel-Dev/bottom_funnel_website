...
export const AlcoholSuggestions = () => {
  ...
  return (
    <div className="alcohol-exlucive-app-main">
      <h1>
      ...
      <div className="alcohol-exlucive-app-content">
        {foodExcluciveAppData.map(({ title, description, img }) => {
          return (
            <div key={title}>
              <div className="alcohol-exlcusive-app-image-div">
