...
import "./FoodDeliveryNeedSuccess.css";
...
export const FoodDeliveryNeedSuccess = () => {
  ...
  return (
    <div className="food-delivery-need-success-main">
      <h1>All You Need to Know For A Successfull Food Business</h1>
      <div>
        <div className="food-delivery-need-success-image">
          <img
            src={foodDeliveryNeedData[active].img.src}
            alt={foodDeliveryNeedData[active].img.alt}
          />
        </div>
        <div className="food-delivery-need-success-content">
          {foodDeliveryNeedData.map(({ title, icon }, idx) => {
            return (
              <div
                key={title}
                onMouseOver={() => setActive(idx)}
                className={`food-delivery-need-success-content-box-${idx}`}
              >
                <div className="food-delivery-need-success-content-logo">
