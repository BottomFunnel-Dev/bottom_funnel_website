...
export const NFTWhyBF = () => {
  return (
    <div className="NFTWhyBF-container">
      <div className="NFTWhyBF-heading">
      ...
      <div className="NFTWhyBF-main">
        <div className="NFTWhyBF-main-image">
          <img
            src="Images/NFTDevPhotos/whyBF.png"
            alt="WHy Bottom Funnel for NFT development services"
          />
        </div>
        <div className="NFTWhyBF-background-triangle-main">
          <img
