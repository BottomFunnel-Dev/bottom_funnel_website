...
export const ConsultingServices = () => {
    ...
    return (
        <div className='consultingServicesWeOfferParentDiv'>
            <div className='consultingServicesWeOfferHeadingDiv'>
                <h1>
                    CONSULTING
                    <span> SERVICES </span>
                    WE OFFER
            ...
            <div className="consultingServicesWeOffers">
                {consultingServicesWeOffer.map(({ title, body, image }, idx) => (
                    <div key={idx}>
                        ...
                        <div className='consultingServicesWeOfferContentCardDiv'>
                            <h3>{title}</h3>
                            <p>{body}</p>
                        </div>
                    </div>
