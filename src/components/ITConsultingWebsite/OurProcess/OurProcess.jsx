...
export const OurProcess = () => {
    return (
        <div className='ourProcessParentDiv'>
            <div className='consultingOurProcessHeadingMainDiv'>
                <h1>
            ...
            <div className='consultingOurProcessImageMainDiv'>
                <img src='/Images/ItConsulting/LampiconsImage.png' alt='image' />

                <div className='consultingOurProcessImageContentDiv'>
                    <div className='consultingOurProcessImageChildDiv'>
                        <h4>
