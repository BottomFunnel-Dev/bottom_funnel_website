...
import "./ConsultingTechTools.css";
...
export const ConsultingTechTools = () => {
    ...
    return (
        <div className="consultingTechTools-container">
            <h1>
                <span> Tech and Tools </span> we use
            </h1>
            <div className="consultingTechTools-hr-line">
                <span></span>
                <div></div>
                <span></span>
            </div>
            <div className="consultingTechTools-main">
