...
import "./ConsultingWhyChooseUs.css";
...
export const ConsultingWhyChooseUs = () => {
    ...
    return (
        <div className="consultingServicesWhyChooosecontainer">
            <h1> But, Why you should consider
                <span> Bottom Funnel </span>
                <h1>for your project</h1>
            </h1>
            <div className="consultingServicesWhyChooosehr-line">
                <span></span>
                <div></div>
                <span></span>
            </div>
            <div className="consultingServicesWhyChooosemain">
                <div className="consultingServicesWhyChoooseimage">
                    <img
                ...
                <div className="consultingServicesWhyChooosecards">
                    {cardsData.map(({ title, body, image }) => (
                        <div key={title}>
                            ...
                            <div className="consultingServiceWhyChooseUsCardsContentDiv">
                                <h2>{title}</h2>
                                <p>{body}</p>
                            </div>
                        </div>
