...
export const VRForm = () => {
  return (
    <div className="VRForm-container">
      <div className="VRForm-stats">
      ...
      <div className="VRForm-main">
        <div className="VRForm-form-outer-main">
          <h1>Get Started Now!</h1>
          <div className="VRForm-form">
            <div className="VRForm-formSection">
              <div className="VRForm-inputWithIcon">
                <IconContext.Provider value={{ className: "VRForm-formIcon" }}>
                  <BsFillPersonFill />
                </IconContext.Provider>
                <input
                  type="text"
                  className="VRForm-inputPart"
                  placeholder="Name"
                />
              </div>
              <div className="VRForm-inputWithIcon">
              ...
              <div className="VRForm-phoneClass">
                <IconContext.Provider value={{ className: "VRForm-formIcon" }}>
                  <BsFillTelephoneFill />
                </IconContext.Provider>
                <select className="VRForm-countryCode" name="" id="">
              ...
              <input
                className="VRForm-phoneNumber"
                type="number"
                placeholder="Phone Number"
              />
              <div className="VRForm-selectClass">
                <IconContext.Provider value={{ className: "VRForm-formIcon" }}>
                  <CgMenuGridR />
                </IconContext.Provider>
                <select className="VRForm-selectPart" name="" id="">
              ...
              <div className="VRForm-textareaClass">
                <IconContext.Provider
                  value={{ className: "VRForm-formMessageIcon" }}
                >
                  <BiMessage />
                </IconContext.Provider>
                <label htmlFor="textarea"> Message</label>
                <textarea
                  className="VRForm-messagePart"
                  name="textarea"
                  id=""
                  cols="15"
                  rows="5"
            ...
            <div className="VRForm-robotCaptcha">
              <button>Get Started</button>
            </div>
          </div>
        </div>

        <div className="VRForm-feature-main">
          <h1>Features</h1>
          <ul>
            <li>
