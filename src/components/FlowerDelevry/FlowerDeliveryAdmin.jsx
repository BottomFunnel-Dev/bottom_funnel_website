...
export const FlowerDeliveryAdmin = () => {
  const [imageChange, setImageChange] = useState(
    "Images/Flowerdeliverypage/Businesscontrol.png",
  );
    ...
    <div className="flowerdeliveryadminmainbox">
      <div className="flowerdeliveryadminflexleftbox">
        ...
        {flowerdeliveryadmindata.map((e) => {
          return (
            <div
              className="flowerdeliveryadmingboxmapping"
              key={e.htxt}
              onMouseEnter={() => {
      ...
      <div className="flowerdeliveryadminflexrightbox">
        <div className="flowerdeliveryadminrightboxforimageone">
          <img src="Images/Flowerdeliverypage/Rectangle4190.png" alt="image1" />
        </div>
        <div className="flowerdeliveryadminrightboxforimagetwo">
