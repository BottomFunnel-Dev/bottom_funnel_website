...
export const FlowerDeliveryDriver = () => {
  const [imageChange, setImageChange] = useState(
    "Images/Flowerdeliverypage/DriverProfile.png",
  );
  ...
  return (
    <div className="flowerdeliverydrivermainboxing">
      <div className="flowerdeliveryflexboxleft">
        <div className="flowerdeliveryflexboxleftimageone">
          <img
            src="Images/Flowerdeliverypage/Rectangle 4192.png"
            alt="image1"
          />
        </div>

        <div className="flowerdeliveryflexboxleftimagetwo">
      ...
      <div className="flowerdeliveryflexboxright">
        ...
        {flowerdeliverydriverdata.map((e) => {
          return (
            <div
              className="flowerdeliverydrivermappingbox"
              key={e.htxt}
              onMouseEnter={() => {
