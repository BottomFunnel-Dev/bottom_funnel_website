...
import './SeoEmailEnquiry.css';


export default function SeoEmailEnquiryNow() {
    return (
        <div className="_SeoEmailEnquiryNowMaindiv">
            <div className="_SeoEmailEnquiryNow">
                <img src="Images/seoemail.png" alt=""/>
            </div>
            <div className="_SeoEmailEnquiryNow">
                <h3>
