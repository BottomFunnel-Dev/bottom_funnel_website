...
return(
        <div className="_SeoEmailexpertsmaindiv">
            <h1>What sets us a part as a Email SEO company?</h1>
              {  data.map((items,i)=>{
                    return(
                        <div className="_SeoEmailinfodiv">
                            <div  className="_SeoEmailinfodiv1">
                                <p key={i}>
                                    {items.heading}
                                </p>
                            </div>
                            <div className="_SeoEmailinfodiv2">
                                <p key={i}>
                                    {items.content}
                                </p>
                            </div>
