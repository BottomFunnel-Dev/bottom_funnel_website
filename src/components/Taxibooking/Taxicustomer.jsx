    ...
    <div className='sztaxicustomercontainer'>
          <div className='sztaxicustomersub'>
                <div className='sztaxicustomerleft'>
                   <div > 
                      <h2>Customer App</h2>
                      <ul><li> Accept/Reject Booking</li>  
                ...
                <div className='szcaricon'> <img src="Images/Taxibooking/splash screen.png"/></div>
                <div className='sztaxidrive'><img src="Images/Taxibooking/taxi driver.png"/></div>
