...
export const GroceryAdmin = () => {
  ...
  return (
    <div className='groceryadminpannelmainboxes'>
    <div className='groceryadminpannelmainboxsometextupper'>
    <h2>Admin Pannel</h2>
    </div>
    <div className='groceryadminpannelmainflexboxclass'>
    <div className='groceryadminpannelleftbox'>{groceryadmindata.map((e)=>{
        return (
    ...
    <div className='groceryamadminpannelrightbox'>
    <div className='groceryamadminpannelrightboxinnerimage'>
