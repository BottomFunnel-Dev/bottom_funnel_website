...
const Grocerycustomerappdata = [
  ...
  return (
    <div className='grocerycustomerappmainboxes'>
   
    <h2>Customer App</h2>
    <div className='grocerydeliveryappflexingbox'>
    <div className='grocerydeliveryappflexingboxleftbox'>
    <div className='grocerydeliveryappleftboxinsiderupperimage'>
    <img src={imageChange} alt='' />
    </div>
    </div>
    <div className='grocerydeliveryappflexingboxrightbox'>{Grocerycustomerappdata.map((e)=>{
        return (
            <div className='grocerydeliveryappindivisualbox'
