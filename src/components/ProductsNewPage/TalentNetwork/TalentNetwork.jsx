...
export const TalentNetwork = () => {
    ...
    return (
        <div className='productsTalentNetworkParentDiv'>
            <div className='productsTalentNetworkHeadingDiv'>
                <h1>
            ...
            <div className="productsTalentNetworkContentDiv">
