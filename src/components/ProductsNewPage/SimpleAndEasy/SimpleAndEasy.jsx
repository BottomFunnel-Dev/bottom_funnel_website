...
export const SimpleAndEasy = () => {
    ...
    return (
        <div className='simpleAndEasyParentDiv'>
            <div className='simpleAndEasyHeadingDiv'>
                <h1>
            ...
            <div className="simpleAndEasyContentDiv">
                {simpleAndEasyCardsData.map(({ title, body, image, buttondetails }, idx) => (
                    <div key={idx}>
                        ...
                        <h3>{title}</h3>
                        <p>{body}</p>
                        <p className='simpleAndEasyContentButton'>{buttondetails}</p>
                    </div>
                ))}
            </div>
        </div>
