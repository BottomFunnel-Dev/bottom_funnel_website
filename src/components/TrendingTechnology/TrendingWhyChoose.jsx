...
export const TrendingWhyChoose = () => {
  ...
  return (
    <div className='trendingtechnologywhychoosemainboxes'>
    ...
    <div className='trendingtechnologywhychoosemainboxesmapperspecialbox'>
    <div className='trendingtexhwhychooseflexbox'>{trendingwhychoosedata.map((e)=>{
        return (
            <div className='indivisuallytrendingwhychooseus'>
            <div className='numberandhtxtindtrentech'>
            
            <div className='numberindtrentech'><h1>{e.no}.</h1></div>
            <div className='textindtrentech'><h4>{e.htxt}</h4></div>
