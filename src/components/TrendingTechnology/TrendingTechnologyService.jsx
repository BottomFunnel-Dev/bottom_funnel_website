...
import "./TrendingTechnologyService.css"
...
const trendingservicesdata = [
  ...
  return (
    <div className='trendingtechnologyservicemainboxes'>
    <div className='trendingtechservicehedertext'>
    ...
    <div className='trendingtechnologyservicedatamappingbox'>{trendingservicesdata.map((e)=>{
        return (
            <div className='trendingtechserindi'>
            <div className='trendingtechnologyboxforimages'>
            <img src={e.image} alt='images' />
            <div className='trendingtechnolboximagetextbox'><h4>{e.htxt}</h4></div>
            </div>
            <div className='trendingtechnologyboxfortext'>
            <p>{e.stxt}</p>
            </div>
            </div>
        )
