...
import "./Politicsreliable.css"

export default function Politicsreliable() {
  return (
    <div className='politicsreliable'>
    <div className='szpoliticreliablehead'>   
    <h1>What makes us reliable</h1>
     </div>
