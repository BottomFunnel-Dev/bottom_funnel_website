...
export const RealEstateSolution = () => {
  ...
  return (
    <div className='realstatesolutionmainboxes'>
    <div className='realestatesolutionsometetxboxupper'>
    ...
    <div className='mainrealestatesolutionflexingwithupertextbox'>
    <div className='realestateuppertextingbox'>
    <h1>Exculusive Features</h1>
    </div>
     <div className='exuclusivefeaturedatamappingrealestatesolution'>
  ...
  <path fill-rule="evenodd" d="M9.224 1.553a.5.5 0 0 1 .223.67L6.56 8l2.888 5.776a.5.5 0 1 1-.894.448l-3-6a.5.5 0 0 1 0-.448l3-6a.5.5 0 0 1 .67-.223z"/>
     ...
     {realestatesolutiondata.map((e)=>{
        return (
            <div className='exclusivefeaturerealestateflexindi'>
            
            <div><h4>{e.txt}</h4></div>
            <div className='indivisualimageforsolutionrealestate'><img src={e.icon} alt='images' /></div>
            <div className='indivisualtextforsolutionrealestate'><p>{e.stxt}</p></div>
