...
const realstatecustomerdata = [
  ...
  return (
    <div className='realestatecustomerboxmain'>
    <div className='realestatecustomerleftbox'>
    <div className='realstatecustomerappleftboxsometextupper'>
    <h1>Customer Application</h1>
    </div>
    <div className='realestatecustomermappingmainbox'>{realstatecustomerdata.map((e)=>{
        return (
            <div className='realstatemapperindivisuallybox'
    ...
    <div className='realestatecustomerrightbox'>
    <div className='realestatecustomerapprightboxformobile'>
