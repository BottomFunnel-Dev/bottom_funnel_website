...
import "./RealEstateAdminPannel.css"
...
export const RealEstateAdminPannel = () => {
  ...
  return (
    <div className='realestateadminpannelmainboxes'>
    
    <div className='realestateadminleftbox'>
    <div className='realestateadminleftinsiderimageupper'><img src={imageChange} alt='images' /></div>
    </div>
    <div className='realestateadminrightbox'>
    <div className='realestateuppertextforleftboxadmin'><h1>Admin pannel</h1></div>
    <div className='realestaterightboxmappingmainbox'>{realestateadmindata.map((e)=>{
        return (
            <div className='realstateadminpannelindidaat'
