...
export const NewsEventSlider = () => {
  ...
  const NextArrow = ({ onClick }) => {
    return (
      <div
        className="NewsEventSlider-slider-arrow NewsEventSlider-slider-next"
        onClick={onClick}
      >
        <FaArrowRight />
      </div>
  ...
  const PrevArrow = ({ onClick }) => {
    return (
      <div
        className="NewsEventSlider-slider-arrow NewsEventSlider-slider-prev"
        onClick={onClick}
      >
        <FaArrowLeft />
      </div>
  ...
  return (
    <div className="NewsEventSlider-sliderDiv">
