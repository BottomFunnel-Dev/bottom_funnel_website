...
export const OttFeatures = () => {
  ...
  return (
    <div className='ott-features-container'>
        <div className="ott-Features-Heading">
        <h1>Features</h1>
        <p>You can take care of the video quality and we take care of everything else</p>
      </div>
      <div className='ott-features-main'> 
        {OttFeaturesData.map((e) => {
         return <div className='ott-features-cards-div'>
          <div className='ott-features-img-para-combo'>
          <img src={e.img} alt="" />
              <p>{e.title}</p>
            </div>
            <div className='ott-features-para-div'>{e.para}</div>
          </div>
        ...
        <div className='ott-features-banner'>
          <img src="Images/ott-app/Component184.png" alt="" />
          <div className='ott-fetures-bannel-text-button-div'>
