...
export const Newspaper = () => {
  ...
  return (
    <div className='newspapermainboxes'>
    <div className='newspaperleftboxforimages'>
    <img src={imageChange} alt='image' />
    </div>
    <div className='newspaperrightboxforsometext'>
...
<div className='newstextboxdisplyaflex'>{newspaperdata.map((e)=>{
  return (
    <div className='newstextboxdisplayindi'
