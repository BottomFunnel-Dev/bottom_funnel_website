...
export const Newsfeature = () => {
  return (
    <div className='newfeaturemainboxes'>
    <div className='newsfeaturelowerbannersometextandimageboxes'>
    <div className='newsfeaturelowerbannersometextboxes'>
    ...
    <div className='newsfeaturelowerbannersomeimageboxes'>
