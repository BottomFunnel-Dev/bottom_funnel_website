...
import "./ContactManagementMaximize.css"
...

{
  ...
  return (
    <div className='contactmanagementmaximizesales'>
    ...
    <div className='contactmanagementmaximizemapperdata'>{contactmanagementmax.map((e)=>{
        return (
            <div className='contactmanagementflexboxresizer'>
            <div className='contactmgmticonbox'>
