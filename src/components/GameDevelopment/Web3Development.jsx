...
import "./Web3Development.css"

const Web3Development = () => {
  return (
    <div className='Web3Developmentmainbox'>
...
<h6>Adventure and Puzzles</h6>
    ...
    <div className='web3developmentflexingboxrightdiv'>
    
    <div className='web3develomentgameboxingimageinnerbox1'>
    <img src='Images/gamedevelopmentpage/Rectangle 18509.png' alt='imageone' />
    </div>
    
    <div className='web3develomentgameboxingimageinnerbox2'>
