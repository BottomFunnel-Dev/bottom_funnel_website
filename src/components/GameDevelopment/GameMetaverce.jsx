...
import "./GameMetaverce.css"

export const GameMetaverce = () => {
  return (
    <div className='gamedevelopmentmetavercemainbox'>
...
<div className='gamemetaverserightdivwhichinnerimage'>
<img src='Images/gamedevelopmentpage/Rectangle 18503.png' alt='imagegameer'/>

</div>

<div className='gamemetaverserightdivwhichinnerimagenext'>
