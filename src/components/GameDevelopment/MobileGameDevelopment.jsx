...
import "./MobileGameDevelopment.css"

export const MobileGameDevelopment = () => {
  return (
    <div className='mobilegamedevelopmentmainbox'>

<div className='mobiledevelopmentflexboxingleft'>
<div className='mobiledevelopmentflexingimageonebox'>
<img src='images/gamedevelopmentpage/Rectangle 18507.png' alt='image1' />
</div>


<div className='mobiledevelopmentflexingimagetwobox'>
