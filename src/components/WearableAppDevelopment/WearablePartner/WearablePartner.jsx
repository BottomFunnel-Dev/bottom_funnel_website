...
import './WearablePartner.css';

export const WearablePartner = () => {
  return (
    <div>
        <div className='wearablePageCards-innermaindiv5'>
            <div className='wearablepath'>
                <div className='wearableheading'>
            <h1>Why Choose Bottom Funnel as Your Wearable App Development Partner?</h1>
            <h6>TOP CLASS EXPERIENCES FOR MOBILE AND WEARABLE DEVICES</h6>
            ...
            <div className='wearablebannerdiv'>
             ...
             <div className='wearablePageCards-innermaindiv4'>
              <div className='wearableinnermaindiv4-1stdiv'>
              ...
              <div className='wearableinnermaindiv4-2nddiv'>
