...
import "./enterpriseDeskService.css";
import { RiArrowDropRightLine } from "react-icons/ri";
import { IconContext } from "react-icons";
export const EnterpriseDeskService = () => {
  return (
    <div className="desk-service">
      <div className="enterprise-desk-service">
        <div className="enterprise-content-side">
          ...
          <h5>
            Learn More{" "}
            <IconContext.Provider value={{ className: "dropright" }}>
              <RiArrowDropRightLine />
            </IconContext.Provider>
          </h5>
        </div>
        <div className="enterprise-gif-side">
          <img
      ...
      <div className="enterprise-desk-service-reverse">
        <div className="enterprise-content-side">
        ...
        <div className="enterprise-gif-side">
          <img src="Images/Enterprise/Animations/power.gif" alt="power" />
        </div>
      </div>
      ...
      <div className="enterprise-desk-service">
        ...
        <div className="enterprise-gif-side">
          <img src="Images/Enterprise/Animations/animation.gif" alt="power" />
        </div>
      </div>
      ...
      <div className="enterprise-desk-service-reverse">
        ...
        <div className="enterprise-gif-side">
          <img src="Images/Enterprise/Animations/vector3.gif" alt="power" />
        </div>
      </div>
      <div className="enterprise-desk-service">
        <div className="enterprise-content-side">
        ...
        <div className="enterprise-gif-side">
          <img src="Images/Enterprise/Animations/vector4.gif" alt="power" />
        </div>
      </div>
      <div className="enterprise-desk-service-reverse">
        <div className="enterprise-content-side">
        ...
        <div className="enterprise-gif-side">
          <img src="Images/Enterprise/Animations/chat.gif" alt="power" />
        </div>
      </div>
    </div>
  );
