...
import "./OnlinePaymentExclusive.css"
...
export const OnlinePaymentExclusive = () => {
  ...
  return (
    <div className='onlinepaymentexclusivemainboxes'>
    <h1><span className='colored'>Exclusive</span> Solutions</h1>
    <div className='onlinepaymentexclusivemappingbox'>{onlinepaymentexclusivedata.map((e)=>{
        return (
            <div className='onlinepaymentexclusivemappingboxindivisually'>
            <div className='onlinepaymentexclusivemappingboxindivisuallyforlogo'>
