...
import "./CollaborationOffers.css";
...
export const CollaborationOffers = () => {
  ...
  return (
    <div className="CollaborationOffers-container">
      <h1>Our Collaboration tools offer</h1>
      <div className="CollaborationOffers-main">
        {cardsData.map(({ title, body, image }) => (
          <div>
            <div className="CollaborationOffers-content">
              <h2>{title}</h2>
              <p>{body}</p>
            </div>
            <span></span>
            <div className="CollaborationOffers-image">
