...
import funnel from "../../../public/Images/bottomfunnel.png";
      ...
      <div className="_MobileAppDevelopmentprocess">
        ...
        <div className="_MobileAppDevelopmentprocessimage">
          <div className="_MobileAppDevelopmentprocess11">
            ...
            <p>
              We help you choose innovation by offering consulting and
              technology support by market understanding helps develop the
              success-oriented application for your firm.
            </p>
          </div>
          <div className="_MobileAppDevelopmentprocess11">
            <h4>Ux & design</h4>
