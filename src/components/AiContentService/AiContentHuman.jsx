...
const aicontenthumandata = [
  ...
  return (
    <div className='aicontenthumanmainboxes'>

  <div className='aicontenthumantextbox'>
  <p>THE WORLDS MOST ADVANCED AI LANGUAGE MODEL</p>
  <h1>Write unique and human-like copy in seconds</h1>
  </div>

  <div className='aicontenthumanbannerimageandtextbox'>
  <div className='aicontentinnerbanneronlybox'>


  <div className='aicontentdatamappermainboxmapping'>{aicontenthumandata.map((e)=>{
    return(
        <div className='aicontentdataboxesindividually'>
        <div className='aicontenthumanlogobox'>
        <img src={e.logo} alt="image" />
        </div>
        <div className='aicontenthumantextboxinner'>
        <h4>{e.htxt}</h4>
        <p>{e.stxt}</p>
        </div>
