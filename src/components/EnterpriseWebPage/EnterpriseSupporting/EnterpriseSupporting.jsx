...
import "./EnterpriseSupporting.css";

export const EnterpriseSupporting = () => {
  return (
    <div className="EnterpriseSupporting-container">
      <div className="EnterpriseSupporting-image">
        <img src="Images/enterpriseWebPhotos/supporting.png" alt="" />
      </div>
      <div className="EnterpriseSupporting-content">
        <h1>
