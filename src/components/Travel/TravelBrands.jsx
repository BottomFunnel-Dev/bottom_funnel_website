...
export default function TravelBrands() {
  ...
  return (
    ...
    <div className='travelbrandheading'>  
    <h1>Brands</h1>
    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Inventore ex, voluptatem iste, porro praesentium placeat aliquid odit quaerat fugit accusamus ducimus numquam facilis quis veritatis ratione et distinctio aliquam mollitia.
    </p>
    </div> 
  <div>
    <Slider {...settings}>
      {homeService.map((item, i) => (
        <div key={i} className="travelhomeServices">
          <div>
