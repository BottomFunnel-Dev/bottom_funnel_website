...

{
  ...
  return (
    <div className='businessanalysisframeworkmainbox'>
    <div className='businessanalysisframeworktxtbox'>
    ...
    <div className='businessanalysisflexingbox'>{BusinessFrameworkdata.map((e)=>{
        return(
        <div className='businessflexingmapforbannerbox'><img src={e.banner} alt="image" />
        <div className='businessflexingmapforlogobox'><img src={e.logo} alt='logo' /></div>

        <div className='businessflexboxmappingtxtandstxt'><h5>{e.htxt}</h5>
        <p>{e.stxt}</p>
        </div>
        </div>
