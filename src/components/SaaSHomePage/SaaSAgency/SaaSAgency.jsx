...
import './SaaSAgency.css'

export const SaaSAgency = () => {
  return (
    <div className='SaaSAgency-maindiv'>
        <h1>Do this and more with Bottom Funnel Sales CRM for SaaS businesses</h1>
        <div className='SaaSAgency-innerdiv'>
        <div className='SaaSAgency-carddiv'>
                <h4>Collaborate across teams in real-time </h4>
                <div className='SaaSAgency-carddivimage'>
