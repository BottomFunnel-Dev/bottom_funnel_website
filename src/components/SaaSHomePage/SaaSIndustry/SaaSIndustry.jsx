...
import './SaaSIndustry.css'

export const SaaSIndustry = () => {
  return (
    <div>
      <div className='SaaSIndustry-maindiv'>
        <h1>Why Bottom Funnel Sales ideal for the  SaaS industry?</h1>
        <div className='SaaSIndustry-innermaindiv'>
            <div className='SaaSIndustry-box'>
                <h4>improve customer acquisition</h4>
                <div className='SaaSIndustry-boximage'>
