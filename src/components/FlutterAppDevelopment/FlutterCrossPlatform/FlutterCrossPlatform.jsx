...
import "./FlutterCrossPlatform.css";

export const FlutterCrossPlatform = () => {

  return (
    <>
      <div className="flutterCrossPlatformMainDiv">
        <div className="flutterCrossPlatformHeading">
        ...
        <div className="flutterCrossPlatformCardBoxDiv">
          <div className="flutterCrossPlatformCardBox">
            <div className="flutterCrossPlatformDataBoxes">
              <div className="flutterCrossPlatformDataIcon">
          ...
          <div className="flutterCrossPlatformCardBox1">
            <div className="flutterCrossPlatformDataBoxes">
              <div className="flutterCrossPlatformDataIcon">
