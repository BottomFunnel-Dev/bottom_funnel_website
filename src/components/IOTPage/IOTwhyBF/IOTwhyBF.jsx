...
export const IOTwhyBF = () => {
  ...
  return (
    <div className="IOTwhyBF-Container">
      <div className="IOTwhyBF-Background-rectangle">
        <img
      ...
      <div className="IOTwhyBF-main">
        ...
        <div className="IOTwhyBF-Cards-Container">
          {cardsData.map(({ title, image, body }) => {
            return (
              <div key={title} className="IOTwhyBF-Cards-main">
                <div>
