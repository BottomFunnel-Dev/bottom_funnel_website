...
export const CloudSolutions = () => {
  ...
  return (
    <div className="CloudSolutions-Container">
      <div className="CloudSolutions-Background-rectangle">
        <img
      ...
      <div className="CloudSolutions-main">
        <h1>
          What You Get from <span>Cloud Computing</span> Consulting
        </h1>
        <div className="CloudSolutions-hr-line">
          <span></span>
          <div></div>
          <span></span>
        </div>
        <div className="CloudSolutions-Cards-Container">
          {cardsData.map(({ title, image, body }) => {
            return (
              <div key={title} className="CloudSolutions-Cards-main">
                <div>
