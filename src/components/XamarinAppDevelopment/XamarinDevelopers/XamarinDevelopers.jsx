...
import "./XamarinDevelopers.css";

export const XamarinDevelopers = () => {

  return (
      <>
        <div className='xamarinDevelopersmainbox'>
            <div className='xamarinDevelopersmainboxinnertextdiv'>
                ...
                <button className='xamarinDevelopersbutton'>Get Started</button>
            </div>
        </div>
      </>
  );
