...
export const CryptoDevApproach = () => {
  return (
    <div className="CryptoDevApproach-container">
      ...
      <div className="CryptoDevApproach-main">
        <div className="CryptoDevApproach-main-upper">
          <div className="CryptoDevApproach-uppercards">
            <div>
              <img
        ...
        <div className="CryptoDevApproach-main-lower">
          <div className="CryptoDevApproach-lowercards">
            <h3>7</h3>
            <p>
