...
export const CryptoDevSlider = () => {
  ...
  const NextArrow = ({ onClick }) => {
    return (
      <div
        className="CryptoDevSlider-slider-arrow CryptoDevSlider-slider-next"
        onClick={onClick}
      >
        <FaArrowRight />
      </div>
  ...
  const PrevArrow = ({ onClick }) => {
    return (
      <div
        className="CryptoDevSlider-slider-arrow CryptoDevSlider-slider-prev"
        onClick={onClick}
      >
        <FaArrowLeft />
      </div>
  ...
  return (
    <div className="CryptoDevSlider-sliderDiv">
      <h1>
        Our <span>Tech</span> Stack
      </h1>
      <div className="CryptoDevSlider-hr-line">
        <span></span>
        <div></div>
        <span></span>
      </div>
