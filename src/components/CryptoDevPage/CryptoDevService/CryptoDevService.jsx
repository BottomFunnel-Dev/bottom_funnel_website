...
export const CryptoDevService = () => {
  ...
  return (
    <div className="CryptoDevService-main">
      <h1>
      ...
      <div className="CryptoDevService-container">
        <div className="CryptoDevService-image">
          <img
            src="Images/CryptoDevPhotos/cryptoservice.png"
            alt="Vector big size image"
          />
        </div>
        <div className="CryptoDevService-content">
