...
import "./TaxiOccassion.css";

export const TaxiOccassion = () => {
    return (
        <div className="taxioccasioncontainer">
          <div className="taxioccasionsub">
            <div className="sztaxi">
              <div className="sztaxihead">
                <h2>A taxi for every occasion</h2>{" "}
              </div>
              <div className="sztaxicard">
                <div className="sztaxioccasion1">
                  <div className="szoccassionimage">
                  ...
                  <div className="sztaxiride">
                    <div>
                      <div className="sztaxiac">
                        <img src="Images/Taxibooking/winter.png" />{" "}
                      </div>
                      <p> AC Cabs</p>
                    </div>
                    <div>
                      <div className="sztaxipocket">
                        <img src="Images/Taxibooking/cost.png" />{" "}
                      </div>
                      <p>Pocket friendly</p>
                    </div>
                    <div>
                      <div className="sztaxicost">
