...
export const EducationSupport = () => {
  return (
   ...
   <div className='educationsupportrighttboxingflexfortext'><p>When people think of customer support, they commonly associate it with companies helping end-users with their product or service. Support, however, also includes helping people working within a company. It could be support provided to prospects, employees, vendors, or partners. One of the best examples of a business that is required to support different sets of people both internally and externally is an educational institution.</p>
    ...
    <div className='educationsupportleftboxingflexforimage'>
