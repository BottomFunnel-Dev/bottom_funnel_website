...
import "./EducationAdministration.css"
...
const educationadministrationdata = [
  ...
  return (
    <div className='educationadminsmainboxes'>
   
    <div className='educationadministartionboxfortext'>
...
<div className='educationadministrationmappingboxmain'>{educationadministrationdata.map((e)=>{
    return (
        <div className='educationadminstrationindivisuallybox'>
        
       <div> <h2>{e.htxt}</h2>
       <p>{e.stxt}</p>
       </div>

        <div className='imageboxforeducationadministrationmapper'>
        ...
        <div className='educationadministrationboxnextflexbox'>
        <div className='educationadminboxnextflexboxleft'>
        ...
        <div className='educationadministartionboxnextflexboxright'>
