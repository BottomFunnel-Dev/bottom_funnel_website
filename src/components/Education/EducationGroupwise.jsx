...
import "./EducationGroupwise.css"

export const EducationGroupwise = () => {
  return (
    <div className='educationgroupwisemainboxes'>
    <div className='educationgroupwisebordertopbox'></div>
    <div className='educationgroupwiseuppertextbox'>
    ...
    <div className='educationgroupwiseflexonebox'>
    <div className='educationgroupwiseflexoneboxleft'>
    ...
    <div className='educationgroupwiseflexoneboxright'>
   ...
   <div className='educationgroupimageboxflexside'>
   <div className='educationgroupimageboxflexsideleft'>
   <img src='Images/Education/vectors/Group 770618.png' alt='images' />
   </div>

   <div className='educationgroupimageboxflexsideright'>
   <img src='Images/Education/vectors/Group 770627.png' alt='images' />
    ...
    <div className='educationgroupwiserightsideborder'></div>
    </div>
  )
}
