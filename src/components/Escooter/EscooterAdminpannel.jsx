...
import "./EscooterAdminpannel.css"
export const EscooterAdminpannel = () => {
  ...
  return (
    <div className='escooteradminpanneluppertxt'>
    <h1 className='colorescooty'>Admin Pannel</h1>
    <div className='escooteradminpannelmainboxes'>
<div className='escooteradminpannelboxleftside'>
<img src={imageChange} alt='' />
</div>

<div className='escooteradminpannelboxrighttside'>{escooteradmindata.map((e)=>{
    return (
        <div className='escooteradminpannelboxrighttsideindivboxes'
