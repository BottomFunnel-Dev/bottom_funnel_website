  ...
  return (
    <div className='szkeyareacontainer'>
          <div className='szkeyareasub'>
                <div className='szkeyarealeft'>
                   <div > 
                      ...
                      <li>lorem Ipsum is simply</li>   
                       <li>lorem Ipsum is simply</li>   
                       <li>lorem Ipsum is simply</li>   
                        <li>lorem Ipsum is simply</li>  </ul> 
                    </div>
                </div>
                ...
                <div className='szkeymap'><img src="Images/Escooter/map.png"/></div>

                <div className='szkeyscooter'><img src="Images/Escooter/blackscooter.png"/></div>
                </div>
         </div>
    </div>
  )
